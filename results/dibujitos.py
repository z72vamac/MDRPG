...
datos = pd.read_csv('./results/results_heuristic.csv')
datos
objval = datos[['Instance', 'List', 'Structure', 'Pct', 'ObjVal_h', 'Time_h']]
objval
...
#
g = sns.catplot(x = 'Structure', y = 'Time_h', hue = 'Pct', kind = 'box', col = 'List', data = objval, aspect = 0.5, sharey = True)
g.savefig('time_h.png')

datos2 = pd.read_csv('./results/results_heuristic.csv')
objval_exact = datos2[['Instance', 'List', 'Structure', 'Pct', 'ObjVal', 'Time', 'Gap']]
improved_gap = (objval['ObjVal_h'] - objval_exact['ObjVal'])/objval_exact['ObjVal']

objval_exact['gap_imp'] = improved_gap

g = sns.catplot(x = 'Structure', y = 'gap_imp', hue = 'Pct', kind = 'box', col = 'List', data = objval_exact, aspect = 0.5, sharey = True)
g.savefig('improved_gap.png')
